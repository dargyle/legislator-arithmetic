...
% -----------------------------------------------------------------------------------------------------
\titlegraphic{\includegraphics[width=0.3\paperwidth]{\string~/downloads/fiscalnote-logo-full.png}}
...
\section{Ideal points in a neural
network}\label{ideal-points-in-a-neural-network}
